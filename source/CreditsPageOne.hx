package; // just doing this shit copy of the CreditsState.hx file to prevent the music from replaying when u go back to page one
...
class CreditsPageOne extends MusicBeatState
{
